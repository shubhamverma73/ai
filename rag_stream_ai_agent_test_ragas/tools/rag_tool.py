...
# ==================================================
# Terminal Safe Printing
# ==================================================

def safe_text(value):
    """
    Convert text into something the active Python console can print.

    Windows terminals often run with a cp1252-style console codec, while
    PDF/document chunks may contain unicode ligatures such as `ﬂ` or `ﬁ`.
    Replacing them instead of crashing is safer for a separate evaluation runner.
    """
    if value is None:
        return ""
