...
def save_chat_history(
    ...
    *args
    ...
    """
    Accept both legacy call styles for the keyword and stream variants:
      save_chat_history(question, answer)
      save_chat_history(question, docs, answer)

    The optional docs payload is ignored because chat history stores only
    the user question and assistant answer tuple.
    """
    answer = args[-1]
